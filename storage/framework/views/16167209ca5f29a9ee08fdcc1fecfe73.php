...
<html lang="en">
  ...
  <body id="page-top">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg bg-warning bg-info text-uppercase fixed-top" id="mainNav">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link border border-primary text-dark py-3 px-0 px-lg-3 rounded" href="#experience">Experience</a></li>
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link border border-primary text-dark py-3 px-0 px-lg-3 rounded" href="#about">About</a></li>
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link border border-primary text-dark py-3 px-0 px-lg-3 rounded" href="#contact">CONTACT</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <!-- Partner Section-->
    <p>
    <section class="page-section bg-dark portfolio" id="experience">
      <div class="container">
        <!-- Partner Section Heading-->
        <h2 class="page-section-heading text-center text-uppercase text-white mb-0">EXPERIENCE</h2>
        <!-- Icon Divider-->
        <div class="divider-custom divider-light">
          <div class="divider-custom-line"></div>
          <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
    ...
    <div class="row bg-warning" id="contact">
      <div class="col-md-6 offset-md-3 p-3">
          ...
          <form id="contact-form">
              ...
              <div class="d-flex justify-content-between">
                <button type="submit" class="btn btn-primary mr-auto p-2">Kirim Pesan</button>
                <div class="m-4">
                  <a href="<?php echo e($instagram); ?>"><i class="fab fa-instagram fa-2x" style="color: #ac2bac;"></i></a>
                  <a href="<?php echo e($youtube); ?>"><i class="fab fa-youtube fa-2x" style="color: #ed302f;"></i></a>
                </div>
              </div>
          </form>
      </div>
...
<?php /**PATH C:\habil\portofolio\resources\views/depan.blade.php ENDPATH**/ ?>