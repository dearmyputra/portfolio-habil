...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link text-dark py-3 px-0 px-lg-3 rounded" href="#EXPERIENCE">EXPERIENCE</a></li>
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link text-dark py-3 px-0 px-lg-3 rounded" href="#about">About</a></li>
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link text-dark py-3 px-0 px-lg-3 rounded" href="#contact">CONTACT</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <!-- Partner Section-->
    <p>
    <section class="page-section bg-warning portfolio" id="EXPERIENCE">
      <div class="container">
...
<?php /**PATH C:\portofolio\resources\views/depan.blade.php ENDPATH**/ ?>