...
} elseif ($_instance->childHasBeenRendered('tAKJGKC')) {
    $componentId = $_instance->getRenderedChildComponentId('tAKJGKC');
    $componentTag = $_instance->getRenderedChildComponentTagName('tAKJGKC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tAKJGKC');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('tAKJGKC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('tXDCR2v')) {
    $componentId = $_instance->getRenderedChildComponentId('tXDCR2v');
    $componentTag = $_instance->getRenderedChildComponentTagName('tXDCR2v');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tXDCR2v');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('tXDCR2v', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\habil\portofolio\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>