...
} elseif ($_instance->childHasBeenRendered('ZyFTcEV')) {
    $componentId = $_instance->getRenderedChildComponentId('ZyFTcEV');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZyFTcEV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZyFTcEV');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('ZyFTcEV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('A3bbpSo')) {
    $componentId = $_instance->getRenderedChildComponentId('A3bbpSo');
    $componentTag = $_instance->getRenderedChildComponentTagName('A3bbpSo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('A3bbpSo');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('A3bbpSo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\portofolio\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>