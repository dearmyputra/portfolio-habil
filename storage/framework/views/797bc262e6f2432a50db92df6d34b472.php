...
} elseif ($_instance->childHasBeenRendered('dxPHrar')) {
    $componentId = $_instance->getRenderedChildComponentId('dxPHrar');
    $componentTag = $_instance->getRenderedChildComponentTagName('dxPHrar');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dxPHrar');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('dxPHrar', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\portofolio\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>