...
} elseif ($_instance->childHasBeenRendered('jxMfxJG')) {
    $componentId = $_instance->getRenderedChildComponentId('jxMfxJG');
    $componentTag = $_instance->getRenderedChildComponentTagName('jxMfxJG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jxMfxJG');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('jxMfxJG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\habil\portofolio\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>